...
var script_valid = require('../data/ritod/script_valid');
var script_invalid = require('../data/ritod/script_invalid');
var tx_valid = require('../data/ritod/tx_valid');
var tx_invalid = require('../data/ritod/tx_invalid');

//the script string format used in ritod data tests
Script.fromritodString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromritodString(vector[0]);
    var scriptPubkey = Script.fromritodString(vector[1]);
  ...
  describe('ritod script evaluation fixtures', function() {
  ...
  describe('ritod transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //ritod casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromritodString(scriptPubKeyStr);
          });
