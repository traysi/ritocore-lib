...
Asset.scriptMarkers = {};
Asset.scriptMarkers.ISSUE = buffer.Buffer.from('72766e71', 'hex');
Asset.scriptMarkers.TRANSFER = buffer.Buffer.from('72766e74', 'hex');
Asset.scriptMarkers.REISSUE = buffer.Buffer.from('72766e72', 'hex');
...
Asset._fromHex = function(str) {
  return Asset._fromBuffer(buffer.Buffer.from(str, 'hex'));
};
